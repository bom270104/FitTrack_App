    ...
    return (
        <div className="flex h-full flex-col bg-background px-6 pb-8 pt-16">
            ...
            <div className="flex flex-1 flex-col gap-4">
                ...
                <button className="self-end text-sm font-medium text-primary">Forgot Password?</button>
                ...
                <div className="flex gap-4">
                    <Button variant="outline" className="h-12 flex-1 rounded-xl border-border">
